...
const jsFiles = ['server.js', 'db.js', 'storage.js', 'export-pdf.js', 'lib/auth-tokens.js', 'routes/auth.js', 'assets/app.js', 'assets/deals-page.css', 'scripts/static-checks.js', 'scripts/mvp-api-smoke.js'];
