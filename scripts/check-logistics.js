...
// Ключи перевозчиков живут в .env (DELLIN_APP_KEY). Скрипт не поднимает
// сервер и не трогает базу, поэтому окружение читаем сами.
...
// Коды Деловых Линий — 25-значные, взяты из их же поиска /v2/public/kladr.json.
// Тринадцатизначный КЛАДР у них не находится, а почтовый индекс молча
// подставляет чужой город (см. комментарий в lib/logistics/dellin.js).
