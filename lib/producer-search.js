...
module.exports = {
    CANDIDATES,
    // normalize нужен ещё и сопоставлению со справочником (lib/catalog-match):
    // приведение регистра и ё→е обязано быть одним на проект, иначе «Ёмкости»
    // и «емкости» разойдутся в разных местах по-разному.
    normalize,
    tokenize,
    pickCandidates,
    buildRankingPrompt,
