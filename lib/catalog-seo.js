...
function buildTitle(page, total) {
    ...
    const head = page > 1
        ...
        // Склонение обязательно: «4531 предприятий» в выдаче читается как
        // недоделанный шаблон, а заголовок — первое, что видит человек.
        : `Каталог производителей России: ${total} ${plural(total, 'предприятие', 'предприятия', 'предприятий')}`;
